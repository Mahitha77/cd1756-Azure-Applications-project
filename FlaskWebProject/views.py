...
# Construct image base url from config
imageSourceUrl = f"https://{app.config.get('BLOB_ACCOUNT')}.blob.core.windows.net/{app.config.get('BLOB_CONTAINER')}/"
